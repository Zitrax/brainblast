...
class ShooterGame : public GameTest
{
  public:
	...
	virtual int  FrameInterval()	{ return 30; }
  ...
  protected:
	...
	std::vector< KrImage* > statusArray;
	KrSprite*	shooter;
  ...
  private:
	...
	enum
	{
		...
		SHIELDSPEED = 1,		// How fast the shield moves

		XSPEED = 4,				// speed of shooter
		MAXMOB = 20,			// max # of monsters
		MOBDELTA = 2,			// speed of monsters
		BULLETSPEED = 5,		// speed of the bullets
		BULLETDELTA = 2,		// speed of the bullet angular motion
...
class SpriteTest : public GameTest
{
  public:
	...
	virtual void DrawFrame();
	virtual int  TestFrames() { return 30; }
...
class TextTest : public GameTest
{
  public:
	...
	virtual void DrawFrame();
	virtual int  TestFrames() { return 268; }
	virtual void VideoExpose() { engine->InvalidateScreen(); }
	virtual int  FrameInterval()	{ return 40; }
...
class ScalingTest : public GameTest
{
  public:
	...
	virtual int  FrameInterval()	{ return 50; }
	virtual void VideoExpose() { engine->InvalidateScreen(); }
